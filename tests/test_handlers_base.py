...
class TestHttpBase(ABC):
    ...
    async def test_download_goaway(self, mockserver: MockServer) -> None:
        ...
        pytest.skip("Needs upstream fixes first")
...
class TestHttpsBase(TestHttpBase):
    ...
    handler_supports_keylogging: bool = True
...
class TestSimpleHttpsBase(ABC):
    ...
    client_settings: ClassVar[dict[str, Any] | None] = None
...
class TestHttpsDefaultCiphersBase(TestSimpleHttpsBase):
    ...
    client_settings: ClassVar[dict[str, Any] | None] = {
